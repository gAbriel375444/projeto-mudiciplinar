  ...
  try {
    ...
    const response = await ai.models.generateContent({
      ...
      config: {
        ...
        3. Nunca tente substituir ajuda médica ou psicológica profissional. Se notar intenções graves de automutilação ou risco à vida, mude o tom para acolhimento emergencial e exiba o contato do CVV (Centro de Valorização da Vida) mandando ligar para o número 188.`,
